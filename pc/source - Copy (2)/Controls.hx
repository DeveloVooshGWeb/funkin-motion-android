...
class Controls extends FlxActionSet
{
	...
	inline function get_UP()
		return _up.check() || dance.DanceServer.up[0];

	public var LEFT(get, never):Bool;

	inline function get_LEFT()
		return _left.check() || dance.DanceServer.left[0];

	public var RIGHT(get, never):Bool;

	inline function get_RIGHT()
		return _right.check() || dance.DanceServer.right[0];

	public var DOWN(get, never):Bool;

	inline function get_DOWN()
		return _down.check() || dance.DanceServer.down[0];

	public var UP_P(get, never):Bool;

	inline function get_UP_P()
		return _upP.check() || dance.DanceServer.up[1];

	public var LEFT_P(get, never):Bool;

	inline function get_LEFT_P()
		return _leftP.check() || dance.DanceServer.left[1];

	public var RIGHT_P(get, never):Bool;

	inline function get_RIGHT_P()
		return _rightP.check() || dance.DanceServer.right[1];

	public var DOWN_P(get, never):Bool;

	inline function get_DOWN_P()
		return _downP.check() || dance.DanceServer.down[1];

	public var UP_R(get, never):Bool;

	inline function get_UP_R()
		return _upR.check() || dance.DanceServer.up[2];

	public var LEFT_R(get, never):Bool;

	inline function get_LEFT_R()
		return _leftR.check() || dance.DanceServer.left[2];

	public var RIGHT_R(get, never):Bool;

	inline function get_RIGHT_R()
		return _rightR.check() || dance.DanceServer.right[2];

	public var DOWN_R(get, never):Bool;

	inline function get_DOWN_R()
		return _downR.check() || dance.DanceServer.down[2];
